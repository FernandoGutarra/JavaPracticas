public class ejercicio_26 {
    ...
    tamaño MAX (que empieza y termina con o más caracteres espacios).
    ...
    public static void main(String[]arg){
        //char [] arrA = {' ','a','b','c',' ','a','e','f','k',' '};
        //char [] arrB = {' ','a','b','b',' ','d','e','f','k',' '};
     // int indeceInicial = buscarIndiceQueMasSeRepite(arrA);
     // int másCaracteresRepetidos = másCaracteresRepetidos(arrB);
     /*
      int finA=buscarFin(arrA,indiceInicial);
      int finB=buscarFin(arrB,másCaracteresRepetidos);
      remplazarSecuAPorSecuB(arrA,indeceInicial,finA,arrB,másCaracteresRepetidos,finB);
     */

    }

    private static void buscarIndiceQueMasSeRepite(char[] arrA) {
        int indeceActual=' ';
